...
@Slf4j
@RestController
@Tag(name = "Spring RestTemplate", description = "Spring RestTemplate component demo", extensions = {
        @Extension(properties = {@ExtensionProperty(name = "x-order", value = "500", parseValue = true)})
})
